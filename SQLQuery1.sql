...
VALUES (
    'user@example.com', -- email (bắt buộc unique)
    '$2a$12$Im82Gf3XxevaL9zDrC09KOZ2Bmvmj24/ernQCje7syRd/AHoWqREi', -- mật khẩu đã hash
    'user',             -- tên hiển thị
    '0123456789',       -- số điện thoại (có thể đổi tuỳ ý)
    1,                  -- active (1 = hoạt động, 0 = vô hiệu hóa)
    'user',             -- role
    GETDATE()           -- thời điểm tạo
);
GO
